...
- (void)viewDidLoad
{
    ...
    [[self.view viewWithTag:1000] setBackgroundColor:[Colors_Modal getUIColorForMain_3]];
    [[self.view viewWithTag:2000] setBackgroundColor:[Colors_Modal getUIColorForMain_1]];
    [[self.view viewWithTag:3000] setBackgroundColor:[Colors_Modal getUIColorForMain_1]];
