...
//    [((UIButton *)[self.view viewWithTag:1001]) setTitleColor:[Colors_Modal getUIColorForNavigationBar_tintColor] forState:UIControlStateNormal];
...
//    [((UIButton *)[self.view viewWithTag:1002]) setTitleColor:[Colors_Modal getUIColorForNavigationBar_tintColor] forState:UIControlStateNormal];
